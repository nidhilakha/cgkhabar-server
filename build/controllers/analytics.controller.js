...
// get user analytics
exports.getUserAnalytics = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
...
exports.getCourseAnalytics = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
...
exports.getOrderAnalytics = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
