...
exports.generateVideoUrl = exports.deleteCourse = exports.getAllCourses = exports.addReplyToReview = exports.addReview = exports.addAnswer = exports.addQuestion = exports.getCourseByUser = exports.getAdminAllCourses = exports.getAllCourse = exports.getSingleCourse = exports.editCourse = exports.uploadCourse = void 0;
...
// upload course
exports.uploadCourse = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
        const data = req.body;
        console.log(data);
...
// edit course
exports.editCourse = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
        const data = req.body;
        const thumbnail = data.thumbnail;
        if (thumbnail) {
            ...
            if (typeof thumbnail === 'object' && thumbnail.public_id && thumbnail.url) {
                ...
                return next(new ErrorHandler_1.default("Invalid thumbnail data", 400));
            }
        }
...
exports.getSingleCourse = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
        const courseId = req.params.id;
...
//   }
// );
exports.getAllCourse = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
...
// admin course
exports.getAdminAllCourses = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
...
exports.getCourseByUser = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
        const userCourseList = req.user?.courses;
        const courseId = req.params.id;
        if (!userCourseList) {
            return next(new ErrorHandler_1.default("User courses not found", 404));
        }
        // Find the course in the user's courses list by courseId
        const courseExists = userCourseList.find((course) => course.courseId === courseId // Match by courseId
        );
        if (!courseExists) {
            return next(new ErrorHandler_1.default("Course not found", 404));
        }
...
exports.addQuestion = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
...
exports.addAnswer = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
...
exports.addReview = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
        const userCourseList = req.user?.courses;
        const courseId = req.params.id;
        ...
        const courseExist = userCourseList?.some((course) => course.courseId === courseId);
        if (!courseExist) {
...
exports.addReplyToReview = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
...
// get all courses
exports.getAllCourses = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
        (0, course_service_1.getAllCoursesService)(res);
    }
    catch (error) {
...
// delete course
exports.deleteCourse = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
        const { id } = req.params;
...
// generate video url
exports.generateVideoUrl = (0, catchAsyncErros_1.catchAsyncError)(async (req, res, next) => {
    try {
