...
layoutRouter.post('/create-layout', auth_1.isAuthenticated, (0, auth_1.authorizeRole)("admin"), layout_controller_1.createLayout);
layoutRouter.put('/update-layout', auth_1.isAuthenticated, (0, auth_1.authorizeRole)("admin"), layout_controller_1.editLayout);
